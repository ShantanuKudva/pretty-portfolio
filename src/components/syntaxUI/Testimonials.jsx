...
const testimonials = [
  {
    name: "Shantanu Kudva",
    description:
      "I have known Dhaatri throughout my college days, and she has been a great friend and a wonderful person. She is very dedicated and hardworking and has a great passion for teaching. She is very patient and understanding and has a great way of explaining things. I am sure she will be a great teacher and will help many students learn and grow.",
...
const TestimonialCard = ({ name, description, image, profession }) => {
  return (
    <div
